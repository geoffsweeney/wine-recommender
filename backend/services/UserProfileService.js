...
var tsyringe_1 = require("tsyringe"); // Import inject
var UserProfileService = function () {
    ...
    var UserProfileService = _classThis = /** @class */ (function () {
        function UserProfileService_1(logger, knowledgeGraphService // Inject KnowledgeGraphService
        ) {
            this.logger = logger;
         ...
         */
        UserProfileService_1.prototype.getPreferences = function (userId) {
            return __awaiter(this, void 0, void 0, function () {
                var preferenceNodes, userPreferences;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            this.logger.debug("UserProfileService: Retrieving preferences for user ".concat(userId));
                            return [4 /*yield*/, this.knowledgeGraphService.getPreferences(userId)];
                        case 1:
                            preferenceNodes = _a.sent();
                            userPreferences = {};
                            preferenceNodes.forEach(function (node) {
                                ...
                                switch (node.type) {
                                    ...
                                    default:
                                        ...
                                        _this.logger.warn("Unknown preference type encountered: ".concat(node.type));
                                        break;
                                }
                            });
         ...
         */
        UserProfileService_1.prototype.savePreferences = function (userId, preferences) {
            return __awaiter(this, void 0, void 0, function () {
                var preferenceNodes;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            this.logger.debug("UserProfileService: Saving preferences for user ".concat(userId, ": ").concat(JSON.stringify(preferences)));
                            preferenceNodes = Object.entries(preferences).map(function (_a) {
                            ...
                            return [4 /*yield*/, this.knowledgeGraphService.addOrUpdateUserPreferences(userId, preferenceNodes)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
