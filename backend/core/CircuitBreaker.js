...
var CircuitBreaker = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (this.state === 'OPEN') {
                            if (this.shouldAttemptReset()) {
                                ...
                                return [2 /*return*/, this.options.fallback(new Error('Circuit is open'))];
                            }
                        }
                        _a.label = 1;
                    case 1:
                    ...
                    case 3:
                        error_1 = _a.sent();
                        this.recordFailure();
                        throw error_1; // Always re-throw the error if the operation fails while circuit is CLOSED or HALF_OPEN
    ...
    CircuitBreaker.prototype._setStateForTesting = function (state, lastFailureTime) {
        this.state = state;
